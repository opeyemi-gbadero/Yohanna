...
public class DeleteAllData extends BaseTest {
	@SuppressWarnings("deprecation")
	@Test
	public void 	TermsOfUse () throws MalformedURLException, URISyntaxException, InterruptedException
	{
        ...
        WebElement DeleteAllData = driver.findElement(AppiumBy.accessibilityId("Delete All Data"));
        DeleteAllData.click();
        ...
        WebElement Toast =driver.findElement(By.xpath("//android.view.View[@index = '0']"));
