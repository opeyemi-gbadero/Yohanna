...
public class PrivacyPolicy extends BaseTest {
	...
	@Test
	public void 	PrivacyPolicy () throws MalformedURLException, URISyntaxException, InterruptedException
	{
        ...
        WebElement PrivacyPolicy = driver.findElement(AppiumBy.accessibilityId("Privacy Policy"));
        PrivacyPolicy.click();
