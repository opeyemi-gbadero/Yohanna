...
public class EmotionCarousel extends BaseTest {
	@SuppressWarnings("deprecation")
	@Test
	public void 	Emotion_Carousel () throws MalformedURLException, URISyntaxException, InterruptedException
	{
		...
		driver.findElement(By.xpath("//android.view.View[@content-desc=\"In the beginning God created the heaven and the earth.\"]/android.widget.ImageView[3]")).click();
		  try {
		        Thread.sleep(3000);
