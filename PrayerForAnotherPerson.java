...
public class PrayerForAnotherPerson extends BaseTest {
	...
	public void 	Request_Prayer () throws MalformedURLException, URISyntaxException, InterruptedException
	{
	  ...
	  try {
	    ...
	    RequestPrayer.click();
	    WebElement ForSomeone = driver.findElement(By.xpath("//android.view.View[@content-desc=\"I want to pray for someone else\"]"));
	    ForSomeone.click();
	    
	    driver.findElement(AppiumBy.accessibilityId("Request Prayer")).click();
	    WebElement Name = driver.findElement(By.xpath("//android.widget.EditText[@index = '1']"));
	    Name.click();
	    Name.sendKeys("Caramel");
	    WebElement Prayer = driver.findElement(By.xpath("//android.widget.EditText[@index = '2']"));
	    Prayer.click();
	    Prayer.sendKeys("She needs prayer for healing");
	    driver.findElement(AppiumBy.accessibilityId("Request Prayer")).click();
