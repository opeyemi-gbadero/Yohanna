...
public class LanguagePreference extends BaseTest {
	...
	public void 	BibleBooks () throws MalformedURLException, URISyntaxException, InterruptedException
	{
        ...
        WebElement Language = driver.findElement(AppiumBy.accessibilityId("Language\nEN"));
        Language.click();
    
        WebElement Portugal = driver.findElement(AppiumBy.accessibilityId("Protuguese"));
        Portugal.click();
        try {
	        Thread.sleep(5000);
	    } catch (InterruptedException e) {
        ...
        WebElement Language2 = driver.findElement(AppiumBy.accessibilityId("Idioma\nPT"));
        
        Language2.click();
       
    
        WebElement English = driver.findElement(AppiumBy.accessibilityId("English"));
        English.click();
